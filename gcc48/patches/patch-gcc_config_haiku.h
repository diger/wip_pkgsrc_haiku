...
--- gcc/config/haiku.h.orig	2014-01-10 03:21:51.297009152 +0000
+++ gcc/config/haiku.h
@@ -0,0 +1,207 @@
...
+#define STARTFILE_SPEC "/boot/system/develop/lib/crti.o%s crtbegin.o%s %{!shared:%{!nostart:/boot/system/develop/lib/start_dyn.o%s}} /boot/system/develop/lib/init_term_dyn.o%s"
+
+#undef  ENDFILE_SPEC
+define ENDFILE_SPEC "crtend.o%s /boot/system/develop/lib/crtn.o%s"
+
